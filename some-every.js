...
/*
Write a function called hasCertainKey which accepts an 
array of objects and a key, and returns true if every 
single object in the array contains that key. Otherwise 
...
function hasCertainKey(arr, key) {
    return arr.every(function(val){
        return val[key] !== undefined; //return key in val;
    })
